document.addEventListener("DOMContentLoaded", function () {
  // Get input elements
  const side1 = document.getElementById("stat-6");
  const side2 = document.getElementById("stat-7");
  const side3 = document.getElementById("stat-8");
  const side4 = document.getElementById("stat-9");
  const side5 = document.getElementById("stat-10");

  // Get canvas element
  const canvas = document.getElementById("pentagonCanvas-2");
